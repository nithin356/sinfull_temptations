<?php
	...
	if($vw_bakery_products_padding_top_bottom != false){
		$vw_bakery_custom_css .='.woocommerce ul.products li.product, .woocommerce-page ul.products li.product{';
			$vw_bakery_custom_css .='padding-top: '.esc_html($vw_bakery_products_padding_top_bottom).'!important; padding-bottom: '.esc_html($vw_bakery_products_padding_top_bottom).'!important;';
		$vw_bakery_custom_css .='}';
	}
	...
	if($vw_bakery_products_padding_left_right != false){
		$vw_bakery_custom_css .='.woocommerce ul.products li.product, .woocommerce-page ul.products li.product{';
			$vw_bakery_custom_css .='padding-left: '.esc_html($vw_bakery_products_padding_left_right).'!important; padding-right: '.esc_html($vw_bakery_products_padding_left_right).'!important;';
		$vw_bakery_custom_css .='}';
	}
	...
	if($vw_bakery_products_box_shadow != false){
		$vw_bakery_custom_css .='.woocommerce ul.products li.product, .woocommerce-page ul.products li.product{';
				$vw_bakery_custom_css .='box-shadow: '.esc_html($vw_bakery_products_box_shadow).'px '.esc_html($vw_bakery_products_box_shadow).'px '.esc_html($vw_bakery_products_box_shadow).'px #ddd;';
		$vw_bakery_custom_css .='}';
	}
	...
	if($vw_bakery_products_border_radius != false){
		$vw_bakery_custom_css .='.woocommerce ul.products li.product, .woocommerce-page ul.products li.product{';
			$vw_bakery_custom_css .='border-radius: '.esc_html($vw_bakery_products_border_radius).'px;';
		$vw_bakery_custom_css .='}';
	}